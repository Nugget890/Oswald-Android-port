...
function onUpdate()
	setProperty('oswaldicon2.x', getProperty('iconP2.x') - 5)
	setProperty('oswaldicon2.y', getProperty('iconP2.y') + 10)
...
function onStepHit()
	...
	if curStep == 952 then
		...
		makeGraphic('cinematicBarsTop', screenWidth, screenHeight / 7, '000000')
		makeGraphic('cinematicBarsBottom', screenWidth, screenHeight / 7, '000000')
        doTweenY('cbta1','cinematicBarsTop', 0, 1, 'circinout')
        doTweenY('cbba1','cinematicBarsBottom', screenHeight - getProperty('cinematicBarsBottom.height'), 1, 'circinout')
	end
